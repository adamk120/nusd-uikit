...
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#9A6AFF", background: "#100C18", backgroundDisabled: "#3c3742", contrast: "#FFFFFF", invertedContrast: "#191326", input: "#483f5a", primaryDark: "#0098A1", tertiary: "#d1e5f7", text: "#1F73BE", textDisabled: "#BDC2C4", textSubtle: "#1F73BE", borderColor: "white", card: "#27262c", gradients: {
